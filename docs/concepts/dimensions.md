...
Each dimension contains a list of labels, identifiers, or dimension items. Dimension items can be hierarchical. For example, a Time dimension may contain months that roll up into quarters and years.
