...
Rules define how values in a model are calculated. A rule typically maps a target cube and slice to a formula expressed in terms of other cubes or slices.
...
- Formulas are visible and auditable in one place.
