...
| `SUMIFS` | `SUMIFS(sum_range, criteria_range1, criteria1, criteria_range2, criteria2, ...)` | Sums values in `sum_range` where all range/criteria pairs match. See ISO 26300 §6.16.63. |
